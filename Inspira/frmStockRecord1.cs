    ...
    public partial class frmStockRecord1 : Form
    {
      ...
      //  DataTable dt = new DataTable();
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                //productID,DrugName,ChemicalName,batchNo,companyName,unitPrice,Quantity,manufacturedDate,expirytDate,purchasedDate
                ...
                frm.txtDrugName.Text = dr.Cells[1].Value.ToString();
                //frm.txtConfigID.Text = dr.Cells[1].Value.ToString();
                frm.txtChemicalName.Text = dr.Cells[2].Value.ToString();
                
                frm.txtBatchno.Text = dr.Cells[3].Value.ToString();
                frm.txtUnitPrice.Text = dr.Cells[5].Value.ToString();
                frm.txtCompanyname.Text = dr.Cells[4].Value.ToString();
                frm.txtQuantity.Text = dr.Cells[6].Value.ToString();
                frm.dtpManufacturedDate.Text = dr.Cells[7].Value.ToString();
                frm.dtpExpiryDate.Text = dr.Cells[8].Value.ToString();
                frm.dtpPurchasedDate.Text = dr.Cells[9].Value.ToString();

              //  frm.txtQuantity.Text = dr.Cells[].Value.ToString();
