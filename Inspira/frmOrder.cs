...
//                 }
              ...
              //  string cib = "insert into sales(orderID,orderDate,CustomerID,Customername,GrandTotal,TotalPayment,PaymentDue,chequeNo,chequeDetails) VALUES ('" + txtInvoiceNo.Text + "',#" + dtpInvoiceDate.Text + "#,'" + txtCustomerID.Text + "','" + txtCustomerName.Text + "'," + txtTotal.Text + "," + txtTotalPayment.Text + "," + txtPaymentDue.Text + ","+ txtchequeNo.Text +", " + txtChqeNotes.Text + ")";
                ...
                string cb = "insert into sales(orderID,orderDate,CustomerID,Customername,GrandTotal,TotalPayment,PaymentDue,chequeNo,chequeDetails) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9)";
                ...
                cmd.Parameters.Add(new MySqlParameter("@d8", MySqlDbType.VarChar, 20, "chequeNo"));
                cmd.Parameters.Add(new MySqlParameter("@d9", MySqlDbType.VarChar, 100, "chequeDetails"));
                ...
                cmd.Parameters["@d8"].Value = txtChequeNo.Text;
                cmd.Parameters["@d9"].Value = txtChqeNotes.Text;
...
//             cmd.Parameters["@find"].Value = txtInvoiceNo.Text;
            ...
            try
            {
                ...
                String cb = "update sales set GrandTotal= " + txtTotal.Text + ",TotalPayment= " + txtTotalPayment.Text + ",PaymentDue= " + txtPaymentDue.Text + ",chequeNo= '" + txtChequeNo.Text + "',chequeDetails= '" + txtChqeNotes.Text +"' where orderID=@find";
                MessageBox.Show("1");
                cmd = new MySqlCommand(cb);
                MessageBox.Show("2");
                cmd.Connection = con;
                ...
                cmd.ExecuteReader();
                con.Close();
                MessageBox.Show("3.25");
                for (int i = 0; i <= ListView1.Items.Count - 1; i++)
                {
                    con = new MySqlConnection(cs);
                    //  con = new OleDbConnection(cs);
                    MessageBox.Show("3.1");
                    string cd = "update orders set quantity=" + ListView1.Items[i].SubItems[4].Text + ",price= " + ListView1.Items[i].SubItems[3].Text + ",totalAmount= " + ListView1.Items[i].SubItems[5].Text + " where orderID='" + txtInvoiceNo.Text + "' and productID= " + ListView1.Items[i].SubItems[1].Text + "";
                  //  MessageBox.Show("liokiujhyg");
                    cmd = new MySqlCommand(cd);
                    MessageBox.Show("3.2");
                    //cmd = new OleDbCommand(cd);
                    cmd.Connection = con;
