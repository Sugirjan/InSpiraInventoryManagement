    ...
    public partial class frmSalesRecord1 : Form
    {
        ...
        public void GetData()
        {
            try
            {
                ...
                con.Open();
                cmd = new MySqlCommand("SELECT orderID,orderDate,CustomerID,Customername,GrandTotal,TotalPayment,PaymentDue,chequeNo,chequeDetails from sales order by orderDate", con);
        ...
        private void frmSalesRecord_Load(object sender, EventArgs e)
        {
            ...
            this.salesTableAdapter1.Fill(this.logindataDataSet11.sales);
            FillCombo();
            GetData();
        ...
        private void cmbCustomerName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
               ...
               // con = new OleDbConnection(cs);
                con.Open();
                cmd = new MySqlCommand("SELECT orderID,orderDate,sales.CustomerID,Customername,grandTotal,TotalPayment,PaymentDue from sales WHERE Customername='" + cmbCustomerName.Text + "' order by Customername,orderDate", con);
        ...
        private void DataGridView3_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frmSales.txtChequeNo.Text = dr.Cells[8].Value.ToString();
                frmSales.txtChqeNotes.Text = dr.Cells[7].Value.ToString();
